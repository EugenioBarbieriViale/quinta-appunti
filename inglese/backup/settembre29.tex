...
\sss[Stanza 6]
Line 4 \t consonance in M \\
Line 4 to 4 \t are run-on-lines because of enjambement \\
Dialog and stanzas are typical of ballads

\sss[Stanza 7]
The narrator speaks \t he says that he can't understand the point of view of the girl \\
Line 4 \t allitteration in M \\

\sss[Stanza 8]
The narrator insists \\
The girl is so compassionate that she considers the 2 siblings alive \\
There is an Aporia = one of the character raises doubt about what another character is saying \\

\sss[Stanza 9]
They are burried together \t side by side, and close to the cottage \t emotional and physical vicinity among them all \\
Line 3 \t internal rhyme between more and door \\
Side by side = diacope = repetition of the same word \\

\sss[Stanza 10]
Knit = cucire, hem = orlare, kerchief = fazzoletto \t she spends her free time near the burried siblings \\

\v

Materialistic point of view of the narrator, who is an adult \t vs the pure and innocent one of the girl
\end{document}
