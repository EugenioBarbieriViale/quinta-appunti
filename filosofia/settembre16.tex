...
All inizio uomo coglie la realta altro da se \t poi attraverso la conoscenza realizza di essere io puro \\
Attivita conoscitiva = modo con cui l uomo capisce di essere io puro

\s[Attivita morale]
Soggetto definisce l' oggetto \t io definisco il valore dell oggetto sulla base della scelta che compio \\
Coltello \t io definisco il suo valore morale \\
L' oggetto diventa l' ostacolo da superare per definirsi moralmente \\
Se uccido con un coltello, io divento cattivo e non il coltello \\
Il male non sta nell oggetto \t l oggetto permette di rivelarmi virtuoso o vizioso \\
L' ente coincide con l' ostacolo che devo superare \\
Non entra nel merito di definire cosa e bene e cosa e male \t la sostanza della realta e perfettamente razionale, quindi non poteva essere altrimenti \\
Spinoza e oggettivista \t qua invece prevale la soggettivita \t il pensiero ponendosi in essere generano essere
\end{document}
