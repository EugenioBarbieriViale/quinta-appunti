...
Le altre opere importanti sono:
\bi
    \item "Aut-aut" nel 43 con diario del seduttore 
    \item "La malattia mortale" del 49 \t parla di disperazione
    \item "Il concetto dell'angoscia" nel 44 \t l'angoscia è la possibilita della liberta
    \item "Briciole filosofiche" nel 44 \t riflette sulla categoria della liberta e maieutica religiosa (come un modo per arrivare a dio) \t ma sono precisazioni sull'opera angoscia
    \item "Timore e tremore" nel 43 \t parla della fede come qualcosa che va al di la di ogni sentimento umano ed etico \t la fede nega la vita etica \t la sintesi è Abramo, che in nome della fede alza il coltello su Isacco \t la fede dice che rapporto con dio puo essere anche paradossale e in conflitto con i principi morali \t fede scardina, mette davanti all'angoscia, supera qualsiasi certezza razionale
    \item diario (33-55), sono 5000 pagine \t e qui ci sono tutti i suoi pensieri e tutta la sua dimensione di fede \t questo diario ha lo stesso stile delle confessioni di Sant'Agostino \t è la sua biografia morale e spirituale, piu che autobiografia
\ei
L'angoscia può avere anche valore formativo \t inizialmente puo tentarlo al suicidio, ma chi fa cosi non ha capito niente \\
Angoscia ridimensiona il mio ego \t provare angoscia di fronte alla molteplicita delle possibilita mi fa capire che sono finito, definisce la mia imperfezione \\
Ha significato formativo perchè mi fa stare nella mia dimensione \t mi puo evitare la disperazione \\
L'angoscia è il sentimento dell'esistenza, e quindi si può leggere da questo punto di vista + positivo
\end{document}
