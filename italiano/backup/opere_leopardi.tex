...
\ss[La quiete dopo la tempesta]
Chiedere prima frase \\
Dal verso 25/26 inizia carrellata intesa di domande e affermazioni categoriche \t verso 32 e seguenti anche, schopenhauer \\
Accumulazione di immagini, frutto del passato \\
Anche chi aborriva la morte, la arriva a scegliere \\
I versi che seguono fino alla fine, si intensificano con dei climax (verso 38, fredde tacite e smorte, verso 41 vento) e parentesi importante: o natura cortese (ossimoro) ... \\
Natura porta uomo a essere titanico, per sopravvivere \\
Immagine dell'incalzare \t tu spargi pene a larga mano (metonimia e aracismo), al vero 47 \t linguaggio quotidiano ed elettivo si collocano in una sintesi leopardiana \\
Vengono intrecciati termini quotidiani (che indicano il borgo) a termini elettivi \\
Verso 48 \t per mostro o miracolo (evoca l'eccezionalità della natura, centra invece con montale)

\ss[Il sabato del villaggio]
Partipazione emotiva dettata dai vezzeggiativi (giovinetta / vecchia) \t due disposizioni dell'animo diverse \\
Il novellare, lo sperare, l'illurdersi \t 2 fasi che caratterizzano la vita di tutti, qui lette in un ambiente ludico \t giocosita dei fanciulli \\
L'operosita degli abitanti \t climax ascendente dove si parla della chiusa bottega (30 in poi) \\
Duplicita iniziale, avvicinarsi al borgo, verso 20 la festa che sta iniziando, la cura per il lavoro nei versi 35/6/7 \t poi riflessione filosofica \\
Apice della riflessione con garzoncello scherzoso \t climax ascendente, operosita del garzoncello \t termine scherzoso, di affettuosita = aspetto ludico legato al non avere fatto i conti con la vita, l'inesperienza \\
L'eta fiorita presenta il focus, che è in fiore (non marcio, come nel giardino) \t l'eta fiorita è come un giorno dell'allegrezza pieno \t no spazio per le ombre

\ss[A silvia]
Aspetti del paesaggio e della figura femminile \t operosità e discovrir del vero \\
Prospettiva post mortem \t ultimi versi, 60 fino alla fine \t la fredda morte e una tomba ignuda mostravi \\
All'apparir del vero \t v. 60 quintissenza \\
Si rivolge direttamente a silvia \t dialogo della prima strofa, ma in assenza dell'interlocutrice \t rende + libero l'autore \t paradigma degli occhi \\
Silvia è Fattorini sotto mentite spogli \t leopardi ama tasso \\
Da 7 a 14 paradigma dell'operosità \\
Il vago e l'infinito \t focalizzano l'età giovanile \t il vago e l'infinito sono molto poetici \\
Il maggio odoroso \t è una sinestesia \\
Natura che risorge, e vita che presenta solo come apice la morte (natura ostile) \\
Quiete stanze \t sinestesia \t riflettono silvia che lavora alla tela e il suono che fa \\
Contrapposizione io/tu \t silvia può cantare mentre lavora la tela, lui studia \\
Paesaggio caratterizzato in modo idilliaco \t dal 23 \\
Linguaggio elettivo e contemporaneo/quotidiano insieme \t verone è  il termine elettivo, accanto invece a termini semplici (come menare il giorno) \\
Coppia di versi (dove ?) \t traccia di dante \t lingua mortale, che non puo dire cio che viene sentito nel cuore dall autore \\
Anafora di che, enjambement \\
Da qui inizia pseudoriflessione filosofica \t fa esclamazione \t tema delle speranze deluse e il varcare il limite del discovir del vero \\
Verso 31-32 \t nella rifl. filosofica \t dolore che schiaccia il petto, affetto da afficior \t non passione, ma un sentimento che schiaccia e una sofferenza \\
Frutto acerbo \t essere soli nella sventura \\
Inizia poi la serie di domande \t che collide con la natura, che inganna i figli suoi \t o natura, o natura \t critica del De Sinner \\
Do ut des con la natura \t verso 39 c'è enjambement \t la natura viene vista snaturata, perche viene posto in evidenza la sua malevolenza verso i suoi figli \\
Verso emblemantico \t "prima che sotto mentite spoglie ... tu morbo chiuso (oscuro, non si sa di cosa è morta)" \t riflessione sulla medicina e sul profilarsi del tempo \t linee di conduzione della chirurgia \\
Immagine di dolcezza che l'ha vinta \t preso dal mondo latino, dove si parla di malattie oscure (victus oscuro morbo) e dolcezza del termine tenerella \\
Da 43 in poi \t chiama all'attenzione la metafora del fiore \t e non ti batteva il core (non hai potuto gustare) \\
Anafora correttiva \t provocatorio \\
L'apparire del vero e silvia che viene immaginata \\
Sivlia non era la sua amante e inoltre lei non era istruita e non apparteneva alla stessa classe sociale

\ss[Alla luna]
Ancor che l'affanno duri \t speme rimembrare, triste affanno \t terminologia di dolore \\
Era solito andare su un monte e guardare la luna \\
Ciclicita della natura \\
Ricordanza al verso 11 e il ricordare il passato, doloroso \\
Nella consapevolezza compare il tempo giovanile \t tempo della speranza è lungo, quello dell'adulto è breve \\
Speranza eta giovanile, ricordo eta adulta \\
Travagliosa vita \t travaglio, il parto e il dolore \\
Salendo il tremulo dal pianto \\
Ciglio sineddoche/metonimia, mentre luci \t dantismo (le luci sono gli occhi di beatrice) \\
Commento che si risolve direttamente alla luna \t vista nel suo massimo splendore, non come l'uomo \\
Dantismo \t in selva \t graziosa: leopardi è romantico, ma la grazia lo connette a una sua preparazione classicista \\
Testo esprime condizione dolorosa, ma ricompone tutto nella consapevolezza \t che accentua il dolore, ma ne possibila l'attraversamento \\
La morte della ragazza, chiedere collegamento

\ss[La sera del di di festa]
Prima trance \t \textbf{declinazione di ogni cosa nel paradigma del nulla} \t il presagio viene dal rimbembrare dall'accaduto di quel giorno di festa \\
La sera del di di festa \t è la disillusione \t io e tu, la donna e l'io del poeta \t non usa il voi, quindi c'è avvicinaemento diverso \\
Io-tu \t continuo rimbalzo e modalita ciceroniana \\
Sintonia con la natura onnipossente \t al verso 13 \t al 14, mi fece all'affanno \t poi discorso diretto libero (speme) \\
Non brilli gli occhi tuoi se non ti pianto \t rimarca \\
Non si pone come la pace della sera domenicale \t ma i pensieri di una retroattivita, di una giornata di festa che non ha risparmiato l'autore dalla sofferenza e dall'esclusione \\
Sei incoraggiata dall'essere individuata ed apprezzata \t io sono nella totale \\
"Questo di fu solenne" verso 16 e verso 21 si ha condensazione di forte tensione e dolore acuto con enumeratio e climax ascendente \t versi importanti \\
Dal 24 in poi \t ritorna l'operosita del borgo \t l'artigiano ritorna a tarda notte \t da citare \\
Dal paesaggio si trova una riflessione sul tempo \\
Il tedio è il punto di noia che anima anche il pensiero filosofico del 900 \t "la noia immoravia", o in Senelità di Svevo \t mentre pirandello meno, è svevo che descrive il non senso della vita \\
Poi Sartre con l'esistenzialismo \\
Le ultime goccie di sanguinosita della politica \t tentativo gramsciano di avvicinare le masse alla cultura attraverso l'intellettuale \\
La recerce du tamp \t Proust e l'effetto madelaine \\
Versi fanno evidenziare fino al 40 \t l'onorabilita di quella roma in cui si combatteva \t non è vero che leopardi non abbia il senso politico, ma è riletto nella sua personalita \\
Questo mondo passato non permette di ragionare piu \t le imprese non vengoo menzionate, la roma si ricorda nel fascismo (mito della grande roma) \\
Il paesaggio e il suo vissuto \t a te la speme nego \t l'immagine di una delusione totale = sofferenza senza limite \\

\ss[A se stesso]
Fine delle illusioni \t torna il climax del di di festa \t qua c'è chiusura della vita \\
Morte spirituale, pur ancora in vita l'autore \t delusione di Fanny, intermediazione poco felice di Ranieri \t tradimento viene superato da leopardi \\
Ricordo vano del salotto dove ha ballato con fanny \t si traducono in versi che mostrano una rivoluzione anche dtecnica nella composzione \t punteggiatura strategica, frasi ridotte all'osso, variatio continua \\
Soliloquio breve \t diretto interlocutore è il cuore (ora riposerai per sempre, tu cuore) \t sdoppiamento dell'animo \\
Responsabile, motore immobile, è l'inganno \t che pero questo è l ultimo \\
Sintassi nodosa, e molti enjambement \t verso 8: amaro e noia la vita (frase nominale) e fango è il mondo \t il mondo è nel suo primordiale inizio \\
L'invito a questa pace, che è morte del cuore \t se il cuore muore, puo continuare a battere \t ma non batte per un sentimento \t allora la vita dove è? vita è ridotta a un meccanismo, a un marchingegno \\
La vita non sta nel meccanicismo biologico \t ma nel posto che si trova nel mondo
\end{document}
