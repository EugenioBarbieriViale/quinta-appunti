...
Carme non è la poesia \t componinemto lungo e in versi \\
Nei sepolcri il tema della sepoltura è prioritario \t figure della cultura letteraria e anche scientifica (newton viene chiamato "l'anglo") \\
Dante ("ghibellin fuggiasco"), Petrarca \\
È ambientato nel cimitero di Santa Croce, a firenze \t i sepolcri esistono perche esiste una cultura sociologica della civilta \\
Inoltre è assente il mondo della scienza, ma è presente quello del costume \t vengono descritti i cimiteri inglesi, dove le ragazze dovevano sostare sulla panche dei cimiteri vicino alle sorgenti d'acqua \\
La tomba rappresenta un nodo di affetti ed è lacrimata \t sono l'emblema del ricordo \t quindi la sepolutra lacrimata immortala l'uomo \t corrispondenza d'amorosi sensi che avviene nell'anima \\
Che cointraddice l'editto napoleonico di Saint Claude \t fossa comune \\
Ma la visione di foscolo è anche un meccanicismo materialistico \t pensiero che prevede una ciclicita, un a partenza per poi tornare alla partenza \\
Anche nel Somnium Scipionis si ha questa circolarità \t perfezione del cerchio \\
Ricerca di perfezione attraverso il materialismo \t porta a ciclicità \\
Filosofia del positivismo \t nesso intrinseco tra causa ed effetto = determinismo meccanicistico, sine qua non la scienza non potrebbe muoversi \\
Nel periodo del positivismo questo determinismo produce una fiducia nel progresso \\
Nel preromanticismo \t spiegazione del nulla eterno che si legge con la ciclicita della vita \t tutto ritorna con la morte \\
Il positivismo si rende conto della fallacia della scienza, che non puo guarire tutti i mali dell uomo \t scienza non puo leggere tutte le imprevidibilita dell uomo 

\v

La fortuna dei sepolcri \t Enzo Noe Girardi \t autore di un saggio critico intitolato "Dell'unita dei sepolcri" \t sepolcri possono non risultare unitari perche quadri di narrazione spezzano \\
Il grande impianto argomentativo dell'opera \t ogni affermazione puo essere ribaltata se non provata 
\end{document}
